...
class MenuNodeUnreal(MenuNodeAbstract):
    ...
    def _setup_menu_item(self, parent_app_node: unreal.ToolMenuEntry = None) -> unreal.ToolMenuEntry:
        """
    ...
    def _setup_separator(self, parent_app_node: unreal.ToolMenuEntry = None) -> None:
